                ...
                <div class="col-lg-8">
                    ...
                    <ul class="article-comments">
                        ...
                        <li className='mb-9'>
                            ...
                            <i class="far fa-thumbs-up"></i> 3 <strong style={{cursor: 'pointer', color: '#FCAF17'}}>Reply</strong>
                            <ul>
                                <li>
                    ...
                    <form>
                        <div class="form-row">
                            ...
                            <input type="text" id="url" class="form-control" name="url" size="30" placeholder="Phone Number*"/>
                            </div>
