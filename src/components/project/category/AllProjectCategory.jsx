...
export default function AllProjectCategory(props) {
    // profects
            ...
            <article class="col-12 pb-5 px-0 px-lg-3">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        ...
                        <Link to={"/category/project/" + props.categoryID} class="badge badge-light badge-lg badge-blog">{props.category}</Link>
                    ...
                    <div className="card-body pt-0 pt-md-4">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            <div className="btn-group">
                                ...
                                <a href={project['frontend_link'] ? ['frontend_link'] : null} target="_blank" className="btn btn-sm btn-outline-secondary btnHover">Code <i className='fa fa-code'></i></a>
                            </div>
                        </div>
                    </div>
                </div>
