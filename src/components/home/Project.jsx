...
class Portfolio extends Component {
    render() {
        return (
          <section id="project" class="py-9 py-xl-12 bg-light">
            <div class="container">
              <div class="row mb-8">
              ...
              <div class="bg-white rounded-lg mt-6 mt-lg-8 p-5 p-sm-8 p-lg-10 text-center">
                <h3 class="mb-5 mb-md-7">Start a project. Get in touch</h3>
                <a href="contact.html" class="btn btn-dark px-8">Hire Me</a>
              </div>
