...
class Footer extends Component {
    ...
    render() {
        ...
        return (
            <footer class="position-relative py-4 py-lg-6 bg-dark text-gray-400">
                    ...
                    <div class="col-lg-10 mx-auto text-center">
                        ...
                        <ul class="list-inline mb-2">
                            ...
                            <li class="list-inline-item mx-0">
                                <a href={github_link} target="_blank" class="btn btn-dark icon icon-3x">
                            ...
                            <li class="list-inline-item mx-0">
                                <a href={linkedin_link} target="_blank" class="btn btn-dark mx-3 icon icon-3x">
