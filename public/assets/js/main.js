...
(function($){
  ...
  var $html = $('html'),
    ...
    siteNavbar_base = $('.site-navbar').attr('data-navbar-base') ? $('.site-navbar').attr('data-navbar-base') : '',
    siteNavbar_toggled = $('.site-navbar').attr('data-navbar-toggled') ? $('.site-navbar').attr('data-navbar-toggled') : '',
    siteNavbar_scrolled = $('.site-navbar').attr('data-navbar-scrolled') ? $('.site-navbar').attr('data-navbar-scrolled') : '',
  ...
  function personite_layoutResize(){
    ...
    if( getWindowWidth() >= 1200 ){
      if ( $siteNavbarToggler.attr('aria-expanded') === 'true' ){
        $siteNavbar.removeClass('navbar-toggled-show');
        $('.site-navbar #navbarCollapse').removeClass('show');
